...
execute if score #tagtime info matches 15 run setblock 281 6 657 minecraft:redstone_block
execute if score #tagtime info matches 25 run setblock 281 6 656 minecraft:redstone_block
