...
execute if score #sqrtmod info matches ..9 run title @s actionbar [{"text":"Nearest player: ","color":"#00BBFF"},{"selector":"@a[tag=pontokanear]"},{"text":" - "},{"text":"X: "},{"score":{"name":"#nearx","objective":"tagcoords"}},{"text":" Y: "},{"score":{"name":"#neary","objective":"tagcoords"}},{"text":" Z: "},{"score":{"name":"#nearz","objective":"tagcoords"}},{"text":" - Distance: "},{"score":{"name":"#sqrt","objective":"info"}},{"text":".0"},{"score":{"name":"#sqrtmod","objective":"info"}}]
execute if score #sqrtmod info matches 10.. run title @s actionbar [{"text":"Nearest player: ","color":"#00BBFF"},{"selector":"@a[tag=pontokanear]"},{"text":" - "},{"text":"X: "},{"score":{"name":"#nearx","objective":"tagcoords"}},{"text":" Y: "},{"score":{"name":"#neary","objective":"tagcoords"}},{"text":" Z: "},{"score":{"name":"#nearz","objective":"tagcoords"}},{"text":" - Distance: "},{"score":{"name":"#sqrt","objective":"info"}},{"text":"."},{"score":{"name":"#sqrtmod","objective":"info"}}]
