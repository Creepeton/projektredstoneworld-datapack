...
execute store result score #nearx tagcoords run data get entity @a[tag=pontokanear,limit=1] Pos[0]
execute store result score #neary tagcoords run data get entity @a[tag=pontokanear,limit=1] Pos[1]
execute store result score #nearz tagcoords run data get entity @a[tag=pontokanear,limit=1] Pos[2]
