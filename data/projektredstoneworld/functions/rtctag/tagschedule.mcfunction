...
execute if score #tagstatus info matches 2 if score #tagtimersec info matches 10.. run bossbar set tagtimer name [{"text":"Head start: ","color":"#FFFF00"},{"score":{"name":"#tagtimermin","objective":"info"},"color":"#FFFF00"},{"text":":"},{"score":{"name":"#tagtimersec","objective":"info"},"color":"#FFFF00"}]
execute if score #tagstatus info matches 2 if score #tagtimersec info matches ..9 run bossbar set tagtimer name [{"text":"Head start: ","color":"#FFFF00"},{"score":{"name":"#tagtimermin","objective":"info"},"color":"#FFFF00"},{"text":":0"},{"score":{"name":"#tagtimersec","objective":"info"},"color":"#FFFF00"}]
execute if score #tagstatus info matches 3 if score #tagtimersec info matches 10.. run bossbar set tagtimer name [{"text":"Time remaining: ","color":"#FF0000"},{"score":{"name":"#tagtimermin","objective":"info"},"color":"#FF0000"},{"text":":"},{"score":{"name":"#tagtimersec","objective":"info"},"color":"#FF0000"}]
execute if score #tagstatus info matches 3 if score #tagtimersec info matches ..9 run bossbar set tagtimer name [{"text":"Time remaining: ","color":"#FF0000"},{"score":{"name":"#tagtimermin","objective":"info"},"color":"#FF0000"},{"text":":0"},{"score":{"name":"#tagtimersec","objective":"info"},"color":"#FF0000"}]
