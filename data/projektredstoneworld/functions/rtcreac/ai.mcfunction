...
execute if score #rtcreactorcoretemp info matches ..319 if score #rtcreactorxenon info matches ..6599 run scoreboard players remove #rtcreactorrodheight info 2
# control rods up by 2 percent if core temp is > 345
execute if score #rtcreactorcoretemp info matches 346.. run scoreboard players add #rtcreactorrodheight info 2
# activate scram if stuff is out of control
execute unless score #rtcreactorcoretemp info matches ..500 unless score #rtcreactorwaterpressure info matches 12000.. run scoreboard players set #rtcreactorrodheight info 1
