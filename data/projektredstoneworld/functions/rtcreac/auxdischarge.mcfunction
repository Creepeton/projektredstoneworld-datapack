...
scoreboard players operation #rtcreactorauxnegwatt info = #rtcreactorauxwattage info
scoreboard players operation #rtcreactorauxnegwatt info *= -1 CONSTANTS
...
scoreboard players operation #rtcreactorintermediate info *= #rtcreactorauxnegwatt info
