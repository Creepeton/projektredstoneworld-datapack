...
scoreboard players operation #rtcreactorintermediate info *= 20720 CONSTANTS
...
execute if score #rtcreactorintermediate info matches ..8500 run scoreboard players set #rtcreactorintermediate info 8500
...
scoreboard players add #rtcreactorintermediate info 25000
scoreboard players operation #rtcreactorcoretemptarget info *= 40000 CONSTANTS
